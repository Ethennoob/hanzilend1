...
class Common_util_pub
{
	...
	public function getSign($Obj)
	{
		...
		//签名步骤二：在string后加入KEY
		$String = $String."&key=".\System\lib\WxPay\WxPayConf_pub::KEY();
	...
	function postXmlSSLCurl($xml,$url,$second=30)
	{
		...
		curl_setopt($ch,CURLOPT_SSLKEY,'/disk2/ftp/buy/www/cert/apiclient_key.pem');
...
class Wxpay_client_pub extends Common_util_pub 
{
	...
	function createXml()
	{
	   	$this->parameters["appid"] = \System\lib\WxPay\WxPayConf_pub::APPID();//公众账号ID
	   	$this->parameters["mch_id"] = \System\lib\WxPay\WxPayConf_pub::MCHID();//商户号
...
{	
	function __construct() 
	{
		...
		//设置curl超时时间
		$this->curl_timeout = \System\lib\WxPay\WxPayConf_pub::CURL_TIMEOUT();
	}
...
class NativeCall_pub extends Wxpay_server_pub
{
	...
	function createXml()
	{
		if($this->returnParameters["return_code"] == "SUCCESS"){
		   	$this->returnParameters["appid"] = \System\lib\WxPay\WxPayConf_pub::APPID();//公众账号ID
		   	$this->returnParameters["mch_id"] = \System\lib\WxPay\WxPayConf_pub::MCHID();//商户号
...
class JsApi_pub extends Common_util_pub
{
	...
	{
		$urlObj["appid"] = \System\lib\WxPay\WxPayConf_pub::APPID();
	...
	{
		$urlObj["appid"] = \System\lib\WxPay\WxPayConf_pub::APPID();
		$urlObj["secret"] = \System\lib\WxPay\WxPayConf_pub::APPSECRET();
	...
	{
		$jsApiObj["appId"] = \System\lib\WxPay\WxPayConf_pub::APPID();
		$timeStamp = time();
